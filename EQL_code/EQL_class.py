...
class EQL_learner:
   ...
   def train(self,**kwagrs):
      benchmark=Benchmark(results_dir=self.result_dir)
      benchmark.benchmark(lambda x,y: x-y, func_name="x-y", trials=20)
      
EQL_learner(results_dir="results/benchmark/test")    
...
# N_TRAIN = 2560       # Size of training dataset
...
# N_TEST = 1000        # Size of test dataset
...
#     bench.benchmark(lambda x,y: x-y, func_name="x-y", trials=20)
